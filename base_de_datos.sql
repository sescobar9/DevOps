...
INSERT INTO `curso` VALUES (1,'matematicas');
...
INSERT INTO `estudiante` VALUES (1,'fredy');
...
CREATE TABLE `estudiante_curso` (
  ...
  KEY `FKa9tyk9fw6cx8btpwjr6lsmfht` (`id_curso`),
  CONSTRAINT `FK8rlacoij7e76dn4js6ny8yf68` FOREIGN KEY (`id_estudiante`) REFERENCES `estudiante` (`id_estudiante`),
  CONSTRAINT `FKa9tyk9fw6cx8btpwjr6lsmfht` FOREIGN KEY (`id_curso`) REFERENCES `curso` (`id_curso`)
...
INSERT INTO `estudiante_curso` VALUES (1,1);
...
CREATE TABLE `task` (
  ...
  `descrpicion` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2024-02-29 16:31:01
